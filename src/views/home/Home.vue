<template>
  <el-row class="container">
    <el-col :span="24" class="header">
      <router-link tag="div" to="/index" class="logo">网上书店管理系统</router-link>
      <div class="userinfo">
      ...
      <aside>
        <el-menu :default-active="$route.path" router unique-opened>
          <template v-for="(item, index) in navRouter">
            <el-menu-item v-if="item.isSingle" :index="item.path" :key="item.children[0].name">
...
<script>
  ...
  export default {
    data() {
      return {
        sysName: "网上书店管理系统",
        defaulImage: "https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fpic1.zhimg.com%2F50%2Fv2-b8f57a87ccff572c84bea1c0497f999d_r.jpg&refer=http%3A%2F%2Fpic1.zhimg.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1638582622&t=37d104e16c8c351764ebd92b623f6caa",
        showRouterView: true,
        audioTips: true,
        orderNotify: {
          newOrderNum: 0,
